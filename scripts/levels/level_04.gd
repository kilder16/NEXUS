...
# === NEXUS - Controlador del Sector 04 ===
# Mismo patrón que level_01/02: tracking + WinScreen al objective.
# Sin gate de boss, guide light visible desde el inicio.

const LEVEL_TITLE: String = "ALMACÉN ASEGURADO"
const LEVEL_NARRATIVE: String = "Inventario destruido. Logística enemiga colapsa.
Último bastión: el Núcleo."
const OBJECTIVE_HINT: String = "Misión: cruzar el almacén y eliminar al jefe local"
