...
# === NEXUS - Controlador del Sector 03 ===
# Mismo patrón que level_01/02: tracking + WinScreen al objective.
# Sin gate de boss, guide light visible desde el inicio.

const LEVEL_TITLE: String = "COMPLEJO MILITAR NEUTRALIZADO"
const LEVEL_NARRATIVE: String = "Has tomado el centro de mando.
Nexus pierde control táctico."
const OBJECTIVE_HINT: String = "Misión: alcanzar la sala de control"
